...
echo.
echo.
echo. Please wait while we load files.
echo. 
...
echo.			██║     ██║     ███████║    ╚██████╔╝╚██████╔╝██║██████╔╝███████╗
echo.
echo.			[Please make sure the provided files are unzipped in the same directory]
echo.			[By using this utility, you agree to the license provided with it]
echo.			[This utility disables UAC, Please enable it with the keybind F later.]
echo.			[Please input a number for any tweaks listed below.]
echo.			    
echo.
echo		             		[1] Disable Animations          [2] Cleaner               
echo	                     		[3] KBM Tweaks                  [4] USB Tweaks            
echo 			    ------------------------------------------------------------
echo			     		[5] GPU Tweaks                  [6] CPU Tweaks            
echo			     		[7] Power Tweaks                [8] Bios Tweaks           
echo 			    ------------------------------------------------------------
echo 			     	[9] CTT Debloat                 [10] Storage Tweaks       
echo  			     	[11] Network Tweaks             [12] FSE Tweaks           
echo 			    ------------------------------------------------------------
...
echo 			    ------------------------------------------------------------
echo 			        [R] Restore Point               [C] Credits              
echo 			        [L] License                     [D] Discord              
echo 			     	[X] Exit			[F] Enable UAC
echo 			    ============================================================
echo.    
echo.			    
echo. 			    
...
:Credits
echo. 
echo. Developed by attack.heli.copter
echo. https://github.com/AttackIsBored
echo. https://discord.com/invite/fpsguide           
echo.      
echo.  
echo.                      
pause > nul 
